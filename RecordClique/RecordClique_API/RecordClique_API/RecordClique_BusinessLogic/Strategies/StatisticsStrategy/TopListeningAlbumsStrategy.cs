...
{
    public class TopListeningAlbumsStrategy : IStatisticStrategy
    {
        private readonly IRepository<Album> _albumRepository;

        public TopListeningAlbumsStrategy(IRepository<Album> albumRepository)
        {
        ...
        public async Task<List<StatisticDTO>> GetStatisticsAsync()
        {
            ...
            var statistics = await albums.Include(a => a.Reviews)
                ...
                .Select(a => new StatisticDTO
                {
                    ...
                    Result = a.UserAlbumLinks.Where(l => l.IsListening == true).Count(),
                    Type = Constants.Statistic.Type.TopListeningAlbumsStrategyType
                })
                .Take(3)
