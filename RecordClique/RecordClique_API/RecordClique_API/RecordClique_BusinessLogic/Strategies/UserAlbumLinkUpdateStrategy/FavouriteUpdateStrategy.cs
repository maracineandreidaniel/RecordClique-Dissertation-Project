...
{
    public class FavouriteUpdateStrategy : IUserAlbumLinkUpdateStrategy
    {
        private readonly IRepository<UserAlbumLink> _userAlbumLinkRepository;

        public FavouriteUpdateStrategy(IRepository<UserAlbumLink> userAlbumLinkRepository)
        {
